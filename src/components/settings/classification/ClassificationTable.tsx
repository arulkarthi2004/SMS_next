...
interface Props {
  data: Classification[];
  onEdit: (row: Classification) => void;
  onDelete: (row: Classification) => void;
}

const ITEMS_PER_PAGE = 5;

export default function ClassificationTable({ data, onEdit, onDelete }: Props) {
  const { t } = useLanguage();
