...
import { getStudentListApi } from "@/api/studentApi";
import {
  ZoomInIcon,
  ZoomOutIcon,
  MaleSvgIcon,
...
export default function StudentListPage() {
  ...
  const students = useAppSelector((state) => state.student.items);
  ...
  }, [students, search, collegeFilter, departmentFilter, levelFilter, statusFilter]);
    ...
    <>
      ...
      <ComponentCard>
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-error-200 bg-error-50 p-8 text-center text-sm text-error-700 dark:border-error-500/20 dark:bg-error-500/10 dark:text-error-400">
            {error}
          </div>
